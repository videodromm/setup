...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    vColour = mix( vColour, vec3(1.0, 1.0, 0.0), PrintValue(fragCoord, vec2(0.0 + 48.0, 5.0), vFontSize, iDate.y, 2.0, 0.0));
    ...
    // Fps
    vColour = mix( vColour, vec3(0.7, 0.0, 0.5), PrintValue(fragCoord, vec2(0.0, 32.0), vFontSize, iFps, 2.0, 0.0));
    // badtv
    vColour = mix( vColour, vec3(0.7, 0.0, 0.5), PrintValue(fragCoord, vec2(0.0, 48.0), vFontSize, iBadTv, 2.0, 0.0));
